...
#  Jul 26, 2019 01:20:37 PM CDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 600x450+1921+185
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    vTcl:DefineAlias "$top.lab78" "Label1" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.scr43 \
        -in $top -x 120 -y 100 -width 311 -relwidth 0 -height 245 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.but44 \
        -in $top -x 240 -y 370 -anchor nw -bordermode ignore 
    place $top.lab78 \
