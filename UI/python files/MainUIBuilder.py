...
class Toplevel1:
    ...
    def select_callback(self):
        ...
        try:
            ...
            self.prereqs = MainUI.get_prereqs(type, self.course_list_slb.get(self.course_list_slb.curselection()[0]))
    ...
    def enter_callback(self):
        ...
        try:
            ...
            self.prereq_storage[index] = self.grade_ety.get()
    ...
    def predict_callback(self):
        try:
            ...
            if 0 <= term_gpa <= 4 and \
                ...
                index = self.prereq_slb.get(0, "end").index(self.prereq_slb.get(tk.ACTIVE))
                file_list = []
                for filename in os.listdir('..\\Data\\models\\' + 'GBT_model_' + model_type):
                    file_list.append(filename)

                model = joblib.load('..\\Data\\models\\' + 'GBT_model_' + model_type + file_list[index] + '.eross')
