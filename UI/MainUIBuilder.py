...
#    Jul 25, 2019 12:09:13 PM CDT  platform: Windows NT
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.course_list_slb.place(relx=0.018, rely=0.096, relheight=0.776
                , relwidth=0.232)
        ...
        self.select_btn.place(relx=0.258, rely=0.495, height=24, width=42)
        ...
        self.select_btn.configure(command=self.course_list_slb.configure(width=10)
        ...
        self.root_cbtn.place(relx=0.312, rely=0.096, relheight=0.034
                , relwidth=0.047)
        ...
        self.all_cbtn.place(relx=0.454, rely=0.096, relheight=0.034
                , relwidth=0.037)
        ...
        self.imme_cbtn.place(relx=0.561, rely=0.096, relheight=0.034
                , relwidth=0.076)
        ...
        self.prereq_slb.place(relx=0.312, rely=0.137, relheight=0.735
                , relwidth=0.384)
    ...
    def course_list_slb.configure(self,p1,p2,p3,p4,p5):
            print('self.course_list_slb.configure')
            sys.stdout.flush()
